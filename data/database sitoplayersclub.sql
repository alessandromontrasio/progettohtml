...
REPLACE INTO `articoli` (`cod_articolo`, `nomearticolo`, `foto`, `descrizione`, `username`, `cod_artista`) VALUES
	(1, 'Nostalgia', 'nostalgia.jpg', 'Nostalgia (export) è il quarto album in studio del rapper italiano Tony Boy, pubblicato il 23 febbraio 2024 dalla Warner Music Italy.', NULL, 1),
	(2, 'I Nomi Del Diavolo', 'inomideldiavolo.jpg', 'I nomi del diavolo è il secondo album in studio del rapper italiano Kid Yugi, pubblicato il 1° marzo 2024 dalle etichette discografiche EMI Records e Universal Music Italia.', NULL, 5),
	(3, 'Aspettando La Bella Vita', 'aspettando.jpg', 'Aspettando la bella vita è il primo album in studio del rapper italiano Artie 5ive, pubblicato il 20 luglio 2023 dalla etichetta discograficha Warner Music Italy.', NULL, 2),
	(4, 'Identità', 'identita.png', 'Identità è il terzo album in studio del rapper italiano Nerissima Serpe, pubblicato il 30 novembre 2023 dalla Universal Music Italia.', NULL, 6),
	(5, 'Gesù Bambino', 'gesubambino.jpg', 'Gesù Bambino è il secondo album in studio del rapper italiano Papa V, pubblicato il 7 ottobre 2022 dalla Sony Music Entertainment Italy.', NULL, 7),
	(6, 'Mario II', 'marioII.jpg', 'Mario II è il secondo album in studio del rapper italiano Low-Red, pubblicato 20 aprile 2021 dalla Thaurus Publishing.', NULL, 3);
...
-- Dump dei dati della tabella playersclub.artista: ~7 rows (circa)
...
CREATE TABLE IF NOT EXISTS `carrello` (
  `username` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL DEFAULT '',
  `cod_articolo` int(11) NOT NULL,
  PRIMARY KEY (`username`,`cod_articolo`),
  KEY `FK_carrello_articoli` (`cod_articolo`),
  CONSTRAINT `FK_carrello_articoli` FOREIGN KEY (`cod_articolo`) REFERENCES `articoli` (`cod_articolo`) ON DELETE CASCADE ON UPDATE CASCADE,
